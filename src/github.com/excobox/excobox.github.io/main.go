...
import (
	...
	"github.com/excobox/excobox.github.io/application"
	"github.com/excobox/excobox.github.io/models"
	"github.com/excobox/excobox.github.io/libunix"
)
...
func newConfig() (*viper.Viper, error) {
	...
	c := viper.New()
	c.SetDefault("dsn", fmt.Sprintf("postgres://%v@localhost:5432/excobox.github.io?sslmode=disable", u))
	c.SetDefault("cookie_secret", "23V8S0Wc-QAn9-vd")
