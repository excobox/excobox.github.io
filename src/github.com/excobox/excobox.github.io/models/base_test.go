...
import (
	"fmt"
	"os"
	"github.com/excobox/excobox.github.io/libstring"
...
func newDbForTest(t *testing.T) *sqlx.DB {
	...
	db, err := sqlx.Connect("postgres", fmt.Sprintf("postgres://%v@%v:%v/excobox.github.io-test?sslmode=%v", pguser, pghost, pgport, pgsslmode))
	if err != nil {
